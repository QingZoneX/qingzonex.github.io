...
export default defineConfig({
  ...
  integrations: [
    starlight({
      title: { 'zh-CN': 'QingZoneX 文档', 'zh-TW': 'QingZoneX 說明文件', en: 'QingZoneX Docs' },
      description: 'QTable 与 QTableUI Phase 1 开源预览文档。',
      locales: {
      ...
      sidebar: [
        ...
        { label: 'QTable', items: [{ slug: 'docs/qtable/overview' }, { slug: 'docs/qtable/architecture' }, { slug: 'docs/qtable/ai-workflows' }, { slug: 'docs/qtable/security' }, { slug: 'docs/qtable/attachments' }] },
        { label: 'QTableUI', items: [{ slug: 'docs/qtable-ui/overview' }, { slug: 'docs/qtable-ui/development' }] },
